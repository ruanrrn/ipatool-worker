 ...
 * @param {Uint8Array} ipa_bytes
 * @param {string} song_list_0_json
 * @param {string} email
 * @returns {Uint8Array}
 */
export function applyPatch(ipa_bytes, song_list_0_json, email) {
    const ptr0 = passArray8ToWasm0(ipa_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(song_list_0_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(email, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.applyPatch(ptr0, len0, ptr1, len1, ptr2, len2);
    if (ret[3]) {
 ...
 * @returns {any}
 */
export function applySignaturesOnly(ipa_bytes, song_list_0_json, email) {
    const ptr0 = passArray8ToWasm0(ipa_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(song_list_0_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(email, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.applySignaturesOnly(ptr0, len0, ptr1, len1, ptr2, len2);
    if (ret[2]) {
 ...
 * @returns {string}
 */
export function buildMobileconfig(manifest_url, display_name) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.buildMobileconfig(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {string}
 */
export function buildOtaManifest(ipa_url, bundle_id, version, title) {
    let deferred6_0;
    let deferred6_1;
    try {
        const ptr0 = passStringToWasm0(ipa_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        ...
        const ret = wasm.buildOtaManifest(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        var ptr5 = ret[0];
        var len5 = ret[1];
        if (ret[3]) {
            ptr5 = 0; len5 = 0;
 ...
 * @returns {Uint8Array}
 */
export function extractIcon(ipa_bytes) {
    const ptr0 = passArray8ToWasm0(ipa_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.extractIcon(ptr0, len0);
 ...
 * @returns {any}
 */
export function extractMetadata(ipa_bytes) {
    const ptr0 = passArray8ToWasm0(ipa_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.extractMetadata(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function inspect(ipa_bytes) {
    const ptr0 = passArray8ToWasm0(ipa_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('ipa_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
